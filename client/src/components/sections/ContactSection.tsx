...
'Please try again or email me directly.';
 ...
 return (
 <section id="contact" className="py-20 bg-theme-card relative transition-colors duration-200">
 ...
 {/* Left Form */}
 <div className="md:col-span-7 bg-theme-bg dark:bg-[#0e0e0e] border border-theme-border rounded-lg p-6 shadow-xs">
 {successResponse ? (
 <motion.div
 ...
 <h3 className="text-lg font-bold text-theme-text font-['Syne',sans-serif] mb-1">
 Message on its way!
 </h3>
 <p className="text-xs text-theme-text-secondary max-w-sm mx-auto mb-5 font-light leading-relaxed">
 {successResponse}
 </p>
 <button
 ...
 className="block text-[11px] font-sans text-theme-text-secondary uppercase tracking-wider mb-1 font-medium"
 >
 Your Name
 </label>
 <input
 ...
 className={`w-full bg-theme-card dark:bg-[#121212] border rounded-lg px-3 py-2 text-xs text-theme-text placeholder:text-slate-400 dark:placeholder:text-zinc-600 focus:outline-none transition-colors font-sans ${
 fieldErrors.name
 ?'border-rose-400 dark:border-red-500/70 focus:border-rose-500'
 :'border-theme-border focus:border-slate-400 dark:focus:border-zinc-600'
 }`}
 />
 {fieldErrors.name && (
 ...
 className={`w-full bg-theme-card dark:bg-[#121212] border rounded-lg px-3 py-2 text-xs text-theme-text placeholder:text-slate-400 dark:placeholder:text-zinc-600 focus:outline-none transition-colors resize-none font-sans ${
 fieldErrors.message
 ?'border-rose-400 dark:border-red-500/70 focus:border-rose-500'
 :'border-theme-border focus:border-slate-400 dark:focus:border-zinc-600'
 }`}
 ...
 <div className="bg-theme-bg dark:bg-[#0e0e0e] border border-theme-border rounded-lg p-5 space-y-4 shadow-xs">
 <h3 className="text-sm font-bold text-theme-text font-['Syne',sans-serif]">
 Direct Contact &amp; Profiles
 </h3>

 <div className="flex items-center justify-between p-3.5 rounded-lg bg-theme-card dark:bg-[#121212] border border-theme-border shadow-2xs">
 <div className="flex items-center gap-2.5">
 <div className="w-8 h-8 rounded-lg bg-theme-bg dark:bg-[#181818] flex items-center justify-center text-theme-text-secondary">
 <Mail className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
 </div>
 <div>
 <div className="text-[10px] text-theme-text-muted font-sans uppercase">Direct Email</div>
 <div className="text-xs font-sans text-theme-text font-medium">{profile?.email ||'contact@example.com'}</div>
 </div>
 </div>
 <button
 type="button"
 onClick={handleCopyEmail}
 className="p-2 text-theme-text-muted hover:text-slate-900 rounded-md bg-theme-bg hover:bg-slate-100 dark:hover:text-white dark:bg-[#181818] dark:hover:bg-[#202020] border border-theme-border transition-colors cursor-pointer"
 ...
 <div className="flex items-center gap-2.5 p-3.5 rounded-lg bg-theme-card dark:bg-[#121212] border border-theme-border shadow-2xs">
 <div className="w-8 h-8 rounded-lg bg-theme-bg dark:bg-[#181818] flex items-center justify-center text-theme-text-secondary">
 <MapPin className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
 </div>
 <div>
 <div className="text-[10px] text-theme-text-muted font-sans uppercase">Based In</div>
 <div className="text-xs font-sans text-theme-text font-medium">{profile?.location ||'India'}</div>
 </div>
 </div>
 ...
 className="flex items-center justify-center gap-2 p-2.5 rounded-lg bg-theme-card hover:bg-slate-50 text-theme-text-secondary hover:text-slate-950 border border-theme-border dark:bg-[#121212] dark:hover:bg-[#181818] dark:hover:text-white text-xs uppercase tracking-wider font-semibold transition-colors shadow-2xs"
 >
