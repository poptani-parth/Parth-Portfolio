...
export const TableLoadingSkeleton: React.FC<{ rows?: number; cols?: number }> = ({ rows = 4, cols = 4 }) => {
 return (
 <div className="w-full bg-theme-card dark:bg-[#121212] rounded-2xl border border-theme-border p-6 overflow-hidden animate-pulse">
...
export const CardLoadingSkeleton: React.FC<{ count?: number }> = ({ count = 3 }) => {
 ...
 <div
 key={idx}
 className="bg-theme-card dark:bg-[#121212] rounded-2xl border border-theme-border p-6 animate-pulse space-y-4"
 >
