        ...
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {categories.map(cat => (
                        ...
                        >
                            ...
                            <div className="text-[11px] font-sans text-slate-400 dark:text-zinc-500 pt-3 mt-3 border-t border-slate-100 dark:border-zinc-800/80">
                                Order priority: <span className="font-bold text-slate-700 dark:text-zinc-300">{cat.displayOrder}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
                    ...
                    <div className="relative w-full max-w-md bg-white dark:bg-[#141414] rounded-2xl border border-slate-200 dark:border-zinc-800 shadow-2xl p-6 sm:p-8 z-10">
                        ...
                        <form onSubmit={handleSave} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-zinc-900 border text-xs font-sans text-slate-900 dark:text-white focus:outline-none ${fieldErrors.name ? 'border-rose-500 bg-rose-50/20' : 'border-slate-200 dark:border-zinc-800'
                                        }`}
                                />
                                {fieldErrors.name && (
