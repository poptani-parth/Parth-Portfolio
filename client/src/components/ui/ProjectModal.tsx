...
export const ProjectModal: React.FC<ProjectModalProps> = ({ project, isOpen, onClose }) => {
 ...
 className="relative w-full max-w-3xl bg-theme-card dark:bg-[#121212] border border-theme-border rounded-2xl shadow-2xl overflow-hidden z-10 my-8 flex flex-col max-h-[90vh]"
 >
 ...
 {/* Metrics Ribbon */}
 {(project.metrics || []).length > 0 && <div className="grid grid-cols-3 divide-x divide-slate-200 dark:divide-zinc-800 border-b border-theme-border bg-theme-bg /60 py-3 px-4 shrink-0">
 {(project.metrics || []).map((metric, idx) => (
 <div key={idx} className="text-center px-2">
 <div className="text-xs font-medium text-theme-text-muted truncate">
 {metric.label}
 </div>
 ...
 {/* Navigation Tabs */}
 <div className="flex border-b border-theme-border px-6 shrink-0 bg-theme-card dark:bg-[#121212]">
 <button
 ...
 :'border-transparent text-theme-text-secondary hover:text-slate-900 dark:hover:text-white'
 }`}
 >
 ...
 {/* Tab Body - Scrollable */}
 <div className="p-6 overflow-y-auto space-y-6 text-theme-text-secondary">
 {activeTab ==='architecture' && (
 <div className="space-y-6">
 <div>
 <h4 className="text-xs font-sans uppercase tracking-widest text-theme-text-muted mb-2">
 System Overview
 </h4>
 <p className="text-sm sm:text-base leading-relaxed text-theme-text">
 {project.description}
 </p>
 </div>

 <div>
 <h4 className="text-xs font-sans uppercase tracking-widest text-theme-text-muted mb-3">
 ...
 <div>
 <h4 className="text-xs font-sans uppercase tracking-widest text-theme-text-muted mb-2.5">
 Technology Stack
 </h4>
 ...
 <span
 key={idx}
 className="text-xs font-sans px-3 py-1 rounded-full bg-theme-bg dark:bg-zinc-800 text-theme-text border border-theme-border font-medium"
 >
 {tech}
 </span>
 ))}
 ...
 <h4 className="text-xs font-sans uppercase tracking-widest text-theme-text-muted">
 ...
 <div
 key={idx}
 className="p-4 rounded-xl bg-amber-500/5 dark:bg-amber-500/10 border border-amber-500/20 text-theme-text"
 >
 ...
 {/* Modal Footer */}
 <div className="p-4 sm:p-6 border-t border-theme-border bg-theme-bg/50 /40 flex items-center justify-between gap-4 shrink-0">
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 rounded-lg text-xs sm:text-sm font-bold text-theme-text-secondary hover:text-slate-900 dark:hover:text-white transition-colors"
 >
 Close
 </button>
 </div>
