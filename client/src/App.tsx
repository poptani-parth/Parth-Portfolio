...
function ProtectedAdminRoute({ children }: { children: React.ReactElement }) {
 ...
 <p className="text-xs text-theme-text-muted font-bold uppercase tracking-wider">
 Verifying Session...
 </p>
 </div>
 </div>
...
function PageSuspenseFallback() {
 return (
 <div className="min-h-screen flex items-center justify-center bg-theme-card">
...
function AppContent() {
 ...
 return (
 <div className="min-h-screen bg-theme-bg text-[#0f172a] dark:text-[#f4f4f5] flex flex-col font-['Plus_Jakarta_Sans',sans-serif] transition-colors duration-200">
