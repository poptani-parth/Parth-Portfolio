...
export const AdminResetPasswordPage: React.FC = () => {
 ...
 <div>
 <label htmlFor="reset-username" className="block text-xs font-semibold text-theme-text-secondary mb-1.5">
 Admin Username
 </label>
 <input
 id="reset-username"
 ...
 className={`w-full px-4 py-3 rounded-xl text-sm bg-theme-bg/80 /80 text-theme-text border ${errors.username ?'border-rose-300' :'border-theme-border'}`}
 />
 ...
 />
 <KeyRound className="w-4 h-4 text-theme-text-muted absolute left-3.5 top-1/2 -translate-y-1/2" />
 </div>
 {errors.token && (
 ...
 className={`w-full px-4 py-3 pl-10.5 pr-11 rounded-xl text-sm bg-theme-bg/80 /80 text-theme-text placeholder:text-slate-400 dark:placeholder:text-zinc-500 border transition-all duration-150 focus:outline-none focus:bg-white dark:focus:bg-zinc-900 ${
 errors.newPassword
 ?'border-rose-300 dark:border-rose-800 focus:ring-2 focus:ring-rose-500/20'
 :'border-theme-border focus:border-slate-400 dark:focus:border-zinc-600 focus:ring-2 focus:ring-slate-400/10'
 }`}
 ...
 className="absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-theme-text-muted hover:text-slate-600 dark:hover:text-zinc-300 cursor-pointer"
